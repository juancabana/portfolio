...
export const translations = {
  en: {
    ...
    awsBadgeCloudTitle: 'AWS Cloud Practitioner',
    awsBadgeCloudSubtitle: 'Amazon Web Services — Certified',
    awsBadgeAITitle: 'AWS AI Practitioner',
    awsBadgeAISubtitle: 'Amazon Web Services — Certified',
    yearsExp: 'YEARS EXP.',
    projects: 'PROJECTS',
    companies: 'COMPANIES',
    ...
    filterTools: 'Tools',
    filterDesign: 'Design',
    awsCertCloudTitle: 'AWS Certified Cloud Practitioner',
    awsCertCloudDesc: 'Cloud computing fundamentals, AWS architecture, security, and pricing',
    awsCertAITitle: 'AWS Certified AI Practitioner',
    awsCertAIDesc: 'AI/ML fundamentals, generative AI concepts, and responsible AI practices',
    showingTech: 'Showing',
    ofTech: 'of',
  ...
  es: {
    ...
    awsBadgeCloudTitle: 'AWS Cloud Practitioner',
    awsBadgeCloudSubtitle: 'Amazon Web Services — Certificado',
    awsBadgeAITitle: 'AWS AI Practitioner',
    awsBadgeAISubtitle: 'Amazon Web Services — Certificado',
    yearsExp: 'AÑOS EXP.',
    projects: 'PROYECTOS',
    companies: 'EMPRESAS',
    ...
    filterDesign: 'Diseño',
    awsCertCloudTitle: 'AWS Certified Cloud Practitioner',
    awsCertCloudDesc: 'Fundamentos de cloud computing, arquitectura AWS, seguridad y pricing',
    awsCertAITitle: 'AWS Certified AI Practitioner',
    awsCertAIDesc: 'Fundamentos de IA/ML, conceptos de IA generativa y prácticas de IA responsable',
